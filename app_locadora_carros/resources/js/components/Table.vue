          ...
          <tbody>
              <tr v-for="obj, chave in dadosFiltrados" :key="chave">
                  ...
                  <td v-if="visualizar.visivel || atualizar.visivel || remover.visivel">
                      ...
                      <button v-if="atualizar.visivel" class="btn btn-outline-primary btn-sm" :data-toglle="atualizar.dataToggle" :data-target="atualizar.dataTarget" @click="setStore(obj)">Atualizar</button>
